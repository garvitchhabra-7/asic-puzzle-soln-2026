#!/usr/bin/env python3
"""Extract the 120-bit solution from a Yosys SAT solve log.

Input bits are at clock cycles 6-125, which map to SAT steps 11-250
(2 steps per cycle). We read I at the clk=0 phase (odd steps: 11,13,...,249).
...
# Input phase: clock cycles 6-125, clk=0 steps are odd: 2*c-1
bits = []
for cycle in range(6, 126):
...
print(f"120-bit solution: {bitstring}")
